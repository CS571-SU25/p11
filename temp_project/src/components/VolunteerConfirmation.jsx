...
function VolunteerConfirmation({
	...
	useEffect(() => {
		const formattedBody = `Name: ${name}%0DEmail: ${email}%0DPhone: ${phone}%0DRoles: ${selected.join(
			', '
		)}%0DConfirmation Number: ${confirmationNumber}`;
	...
	return (
		<Alert variant="success" className="mt-3 text-center">
			...
			<p className="text-info">
				A confirmation email window should have opened in your email
				program.
			</p>
		</Alert>
	);
